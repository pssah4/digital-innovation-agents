...
description: Method cards for user research, observation, and insight work. The Business Analysis agent proposes these when the problem space or the user group is still unclear.
---
...
- [Expert conversations](#expert-conversations)
...
- [User motivation analysis](#user-motivation-analysis)
- [Persona synthesis cluster](#persona-synthesis-cluster)
- [Persona](#persona)
- [Value proposition chain](#value-proposition-chain)
- [Research mind map](#research-mind-map)
- [Stakeholder map](#stakeholder-map)
- [Market and trend analysis](#market-and-trend-analysis)
