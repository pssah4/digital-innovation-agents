...
2. Kritischer Review gegen die reale Codebase
3. Aenderungen in Artefakte zurueckschreiben
4. Handoff an den Default Claude Code Agent
5. Nach Abschluss: /testing -> /security-audit empfehlen
